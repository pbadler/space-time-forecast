...
\noindent \emph{Corresponding author:} Peter Adler, Department of Wildland Resources and the Ecology Center, Utah State University, Logan, Utah, 84322, USA; email: peter.adler@usu.edu; tel: 435-797-1021
...
The truth is represented by a simulation model that is mechanistic for at least one important process, 
but we treat the data-generating model as unknown when analyzing the data and we assumed that perfectly recovering the mechanisms
...
\subsubsection*{Data accessibility statement:} The manuscript contains no original data. All computer code is uploaded for review in a zip file. Upon acceptance of the manuscript, code will be archived at Zenodo.

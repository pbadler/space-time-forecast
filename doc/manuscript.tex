...
Code for simulating dynamics and reproducing the analyses in this paper is available on Github \texttt{https://github.com/pbadler/space-time-forecast}) and
archived on Zenodo \texttt{https://zenodo.org}).
